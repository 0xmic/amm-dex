...
async function main() {
  ...
  // Send CT tokens to investor 1
  transaction = await ct.connect(deployer).transfer(investor1.address, tokens(10))
  ...
  // Send CT tokens to investor 3
  transaction = await ct.connect(deployer).transfer(investor3.address, tokens(10))
  await transaction.wait()
  ...
  ///////////////////////////////////////////////////////////////
  // Investor 1 Swaps: CT --> USD
  //

  // Investor approves all tokens
  console.log(`Investor 1 swapping CT for USD...\n`)
  transaction = await ct.connect(investor1).approve(amm.address, tokens(10))
  await transaction.wait()
  ...
  ///////////////////////////////////////////////////////////////
  // Investor 2 Swaps: USD --> CT
  //

  // Investor approves all tokens
  console.log(`Investor 2 swapping USD for CT...\n`)
  ...
  ///////////////////////////////////////////////////////////////
  // Investor 3 Swaps: CT --> USD
  //

  // Investor approves all tokens
  console.log(`Investor 3 swapping CT for USD...\n`)
  transaction = await ct.connect(investor3).approve(amm.address, tokens(10))
  await transaction.wait()
  ...
  ///////////////////////////////////////////////////////////////
  // Investor 4 Swaps: USD --> CT
  //

  // Investor approves all tokens
  console.log(`Investor 4 swapping USD for CT...\n`)
