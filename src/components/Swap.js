...
const Swap = () => {
  ...
  const swapHandler = async (e) => {
    ...
    // Swap token depending on which one we're doing
    if (inputToken === 'CT') {
          ...
          <Form onSubmit={swapHandler} style={{ maxWidth: '450px', margin: '50px auto' }}>
            ...
            <Row className='my-3'>
              ...
              <InputGroup>
                ...
                >
                  <Dropdown.Item onClick={(e) => setInputToken(e.target.innerHTML)} >CT</Dropdown.Item>
            ...
            <div className='d-flex justify-content-between'>
              ...
              <InputGroup>
                ...
                >
                  <Dropdown.Item onClick={(e) => setOutputToken(e.target.innerHTML)} >CT</Dropdown.Item>
